...
import { deleteBarberAction } from "@/app/dashboard/actions";
                ...
                <tr key={barber.id} className="transition-colors hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center justify-end gap-2">
                      <Link
                        href={`/dashboard/barbeiros/editar/${barber.id}`}
                      ...
                      <ConfirmDeleteButton
                        ...
                        id={barber.id}
                        errorPath="/dashboard/barbeiros"
                        successPath="/dashboard/barbeiros"
                        itemLabel={barber.name}
                      />
                    </div>
                  </td>
                </tr>
