  ...
  return (
    <section className="mx-auto flex w-full max-w-4xl flex-col gap-6">
      <header className="flex items-center justify-between gap-3">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-gray-900 dark:text-white">Novo cliente</h2>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Cadastre um novo cliente para agendamentos.</p>
        </div>
        <Link
      ...
      <section className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        <form action={createClientAction} className="grid gap-4 md:grid-cols-2">
          <input type="hidden" name="errorPath" value="/dashboard/clientes/novo" />
