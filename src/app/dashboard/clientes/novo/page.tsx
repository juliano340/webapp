  ...
  return (
    <section className="mx-auto flex w-full max-w-4xl flex-col gap-6">
      <header className="flex items-center justify-between gap-3">
        <div>
          <h2 className="text-3xl font-black tracking-tight text-black">Novo cliente</h2>
          <p className="mt-1 text-sm text-zinc-500">Cadastre um novo cliente para agendamentos.</p>
        </div>
        <Link
